...
SubModel = (function(_super) {
  ...
  SubModel.prototype.find = function(query, flag, id) {
    var deferred, field, match, matched, mode, obj, oid, path, pipelines, project, s, schema, select, value, w, _i, _j, _len, _len1, _ref, _ref1, _ref2;
    deferred = Q.defer();
    ...
    oid = this.model.base.Types.ObjectId(query[this.link]);
    pipelines = [
      {
        $match: {
          _id: oid
