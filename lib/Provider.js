var NapModel, Provider, Q, SubModel, _,
...
Provider = (function() {
  ...
  Provider.prototype.post = function(req, res, next) {
    var format;
    format = this.format;
    return this.napModel.create(_.assign(req.body, req.query), req.allow, req.user ? req.user._id : void 0).then(function(result) {
      return res.json(format(result));
    }).fail((function(_this) {
      return function(err) {
        if (!isNaN(err.message)) {
